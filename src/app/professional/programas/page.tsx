    ...
    <div className="bg-slate-50 min-h-screen">
      <div className="max-w-2xl mx-auto px-4 py-10 space-y-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-800 mt-2">Constructor de programas</h1>
          <p className="text-sm text-slate-500 mt-1">Seleccioná un paciente para armar o editar su programa de entrenamiento.</p>
        </div>
        ...
        {clients.length === 0 ? (
          ...
          <ClientList clients={withLabel} basePath="/professional/programas" showExport showImport />
        )}
      </div>
    </div>
  );
